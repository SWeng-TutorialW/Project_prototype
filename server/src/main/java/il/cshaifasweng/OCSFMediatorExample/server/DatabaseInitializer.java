...
public class DatabaseInitializer {
    ...
    private static List<Flower> initializeFlowers(Session session) {
        ...
        Flower pf1 = new Flower("Classic Carnation", 12.99, "Lily", "images/FlowerImages/Carnation.png", "White", "Flower");
        ...
        Flower pf4 = new Flower("Dazzling Dahlia", 21.99, "Daffodil", "images/FlowerImages/Dahlia.png", "Red", "Flower");
        ...
        Flower pf6 = new Flower("Fragrant Freesia", 14.99, "Daffodil", "images/FlowerImages/Freesia.png", "Purple", "Flower");
